...
if (window.breakdanceTooltipInstances && window.breakdanceTooltipInstances[tooltipId]) {
  window.breakdanceTooltipInstances[tooltipId].update();
    ...
    {
        return [['cssProperty' => 'margin-top', 'location' => 'outside-top', 'affectedPropertyPath' => 'design.spacing.margin_top.%%BREAKPOINT%%'], ['affectedPropertyPath' => 'design.spacing.margin_bottom.%%BREAKPOINT%%', 'cssProperty' => 'margin-bottom', 'location' => 'outside-bottom']];
    }
    ...
    {
        return [['accepts' => 'string', 'path' => 'content.tooltip.text']];
    }
