 ...
 * @return array
 */
function importPostOrPage($url, $id, $post_type = 'post')
{
    $request = remotePostToWpAjax($url, 'breakdance_design_lib_get_post_data', ['id' => $id, 'post_type' => $post_type]);
