<?php
/**
 * Template Name: Home Page Simple Float - Jericho Case Logs
 * Description: Minimal home page with only subtle floating box animations
 */
...
<style>
    ...
    /* Features section with subtle float */
    .jcl-features {
        display: grid;
    ...
    .jcl-feature-card:nth-child(2n) {
        animation-delay: 1s;
    }
    .jcl-feature-card:nth-child(3n) {
        animation-delay: 2s;
    }
    ...
    .jcl-professional-card:nth-child(2) {
        animation-delay: 1.5s;
    }
    .jcl-professional-card:nth-child(3) {
        animation-delay: 3s;
    }
    .jcl-professional-card:nth-child(4) {
    ...
    /* Mobile responsive - disable animations on small screens */
