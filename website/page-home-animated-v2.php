<?php
/**
 * Template Name: Home Page Animated V2 - Jericho Case Logs
 * Description: Stable animated home page - CSS only, no JavaScript crashes
 */
...
<style>
    ...
    /* 3D ANIMATED SCREENSHOT CARDS - CSS ONLY! */
    .jcl-screenshot-card {
