<?php
/**
 * Template Name: Home Page - Jericho Case Logs
 * Description: Custom home page template for Jericho Case Logs app
 */
...
<style>
    /* Custom styles for Jericho Case Logs home page */
    .jcl-section-title {
        text-align: center;
        font-size: 36px;
        color: #e0fbfc;
...
<div id="primary" class="content-area">
    <main id="main" class="site-main">
        ...
        <div class="jcl-screenshot-showcase">
            <h2>Your Career Command Center</h2>
