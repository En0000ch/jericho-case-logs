<?php
/**
 * Template Name: Home Page Refined - Jericho Case Logs
 * Description: Refined home page matching your dark theme with screenshot showcase
 */
...
<style>
    ...
    .jcl-hero {
        background: rgba(46, 50, 65, 0.6); /* Subtle dark overlay */
        color: #e0fbfc; /* Your theme's text color */
        padding: 40px 40px;
        text-align: center;
        border-bottom: 2px solid rgba(238, 108, 77, 0.3); /* Subtle accent */
        margin-bottom: 60px;
    }
    .jcl-hero h1 {
        font-size: 32px;
    ...
    /* Features section - matches your theme */
    .jcl-features {
        display: grid;
