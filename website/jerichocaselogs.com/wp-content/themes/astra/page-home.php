...
<style>
    ...
    .jcl-professional-card:nth-child(1) { animation-delay: 0s; }
    .jcl-professional-card:nth-child(2) { animation-delay: 1s; }
    .jcl-professional-card:nth-child(3) { animation-delay: 2s; }
    .jcl-professional-card:nth-child(4) { animation-delay: 3s; }
    ...
    @media (max-width: 768px) {
        ...
        .jcl-screenshot-card, .jcl-feature-card, .jcl-professional-card { animation: none; }
    }
</style>
