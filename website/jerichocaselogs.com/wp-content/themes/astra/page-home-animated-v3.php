<?php
/**
 * Template Name: Home Page Animated V3 - Jericho Case Logs
 * Description: Animated home page - animations disabled ONLY on phones, enabled on tablets+
 */
...
<style>
    ...
    /* MOBILE PHONES ONLY - DISABLE ANIMATIONS (max-width: 480px) */
    @media (max-width: 480px) {
        /* Disable ALL animations on phones */
        *,
        *::before,
        *::after {
        ...
        .jcl-hero h1 { font-size: 24px; }
        .jcl-hero p { font-size: 15px; }
        .jcl-section-title { font-size: 24px; }
    ...
    /* TABLETS AND UP - KEEP ANIMATIONS (min-width: 481px) */
    @media (min-width: 481px) and (max-width: 768px) {
        .jcl-hero h1 { font-size: 28px; }
        .jcl-hero p { font-size: 16px; }
        .jcl-section-title { font-size: 28px; }
        .jcl-screenshot-grid { grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); }
    }
