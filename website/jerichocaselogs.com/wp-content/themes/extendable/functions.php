...
// Add Google Model Viewer library to site header
...
/**
 * JerichoCaseLogs - Enqueue Dark Theme CSS and GSAP Animations
 * Added for immersive scroll-based landing page
 */
function jcl_enqueue_landing_page_assets() {
    ...
    // Enqueue Dark Theme CSS
    wp_enqueue_style(
        'jcl-dark-landing',
        get_template_directory_uri() . '/assets/css/dark-landing.css',
        array(),
        EXTENDABLE_THEME_VERSION
    );
    ...
    // Enqueue GSAP ScrollTo Plugin (for smooth scroll)
    wp_enqueue_script(
        'gsap-scrollto',
        'https://cdn.jsdelivr.net/npm/gsap@3.12/dist/ScrollToPlugin.min.js',
        array('gsap'),
        '3.12',
        true
    );
    
    // Enqueue Custom Scroll Animations
    wp_enqueue_script(
        'jcl-scroll-animations',
...
add_action('wp_enqueue_scripts', 'jcl_enqueue_landing_page_assets');
...
// Raw HTML shortcode for hero section
